                    ...
                    user?.let {
                        ...
                        if (showSignOutDialog.value) {
                            AlertDialog(
                                ...
                                text = {
                                    Text("Are you sure you want to log out?", fontFamily = Roboto,
                                        fontWeight = FontWeight.SemiBold,
                                        fontSize = 17.sp)
                                },
                                confirmButton = {
                                    TextButton(onClick = { showSignOutDialog.value = false }) {
                                        Text("No", color = Color(0xFFA30000),
                                            fontFamily = Roboto,
                                            fontSize = 15.sp,
                                            fontWeight = FontWeight.Bold)
                                    }
                                ...
                                dismissButton = {
                                    TextButton(
                                        ...
                                        Text("Yes", color = Color(0xFF008000),
                                            fontFamily = Roboto,
                                            fontSize = 15.sp,
                                            fontWeight = FontWeight.Bold)
                                    }
            ...
            EditAccountOverlay(
                ...
                onSave = { updatedValue, newPassword ->
                    when (fieldToEdit.value) {
                        ...
                        "password" -> userController.handleEditAccount(password = updatedValue, newPassword = newPassword)
                    }
...
fun EditAccountOverlay(
    ...
    val fieldValue = remember { mutableStateOf(when (field) {
        "username" -> username
        else -> ""
    }) }
        ...
        Card(
            ...
            Column(
                ...
                saveMessage.value?.let {
                    ...
                    Text(
                        text = it,
                        color = if (it.contains("successfully")) Color(0xFF008000) else Color(0xFFA30000),
                        fontSize = 14.sp,
                        fontWeight = FontWeight.Bold,
